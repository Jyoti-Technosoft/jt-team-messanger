            ...
            <div className="card register-card border-0 mt-3">
              <div className="card-body">
                ...
                <p className="text-start">
                  Connect with your Friend's around the world.
                </p>
                <img
                  className="register-img mt-3"
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="my-3">
                ...
                {formik.errors.firstName && formik.touched.firstName ? (
                  <p className="register-errors w-100 mt-2 border-0">
              ...
              <div className="my-3">
                ...
                {formik.errors.lastName && formik.touched.lastName ? (
                  <p className="register-errors mt-2">
              ...
              <div className="my-3 input-radio-div text-start">
                ...
                {formik.errors.gender && formik.touched.gender ? (
                  <p className="register-errors text-center mt-2">
              ...
              <div>
                <p className="register-to-login">
                  ...
                  <span className="login-link" onClick={openNavigate}>
                    Login
                  </span>
                </p>
              </div>
